...
from .weight_pool import WeightPool, WeightPoolView
from .frequency_scheduler import FrequencyScheduler, FrequencyLevel, AdaptiveFrequencyController
from .strategy_allocation import StrategyAllocator, StrategyRegistry
from .dual_engine import DualEngineCoordinator
...
class AttentionSystem:
    ...
    def process_snapshot(
        ...
        global_attention = self.global_attention.update(snapshot)
