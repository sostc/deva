...
from ..strategy.strategy_manager import get_manager as get_strategy_manager
...
class AICodeGenerationUI:
    ...
    async def _save_to_datasource_manager(self, code: str, unit_info: Dict[str, Any], ctx: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # 创建数据源单元
            from ..datasource.datasource import DataSource, DataSourceMetadata, DataSourceState
    ...
    async def _save_to_task_manager(self, code: str, unit_info: Dict[str, Any], ctx: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # 创建任务单元
            from ..tasks.task_unit import TaskUnit, TaskMetadata, TaskState, TaskExecution
