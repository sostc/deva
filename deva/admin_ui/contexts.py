...
def tasks_ctx(ns):
    return {
        ...
        'put_buttons': ns.get('put_buttons'),
        'put_row': ns['put_row'],
        ...
        'run_async': ns.get('run_async'),
        'file_upload': ns.get('file_upload'),
        'radio': ns.get('radio'),
        'checkbox': ns.get('checkbox'),
        'stop_task': ns.get('stop_task'),
        'start_task': ns.get('start_task'),
        'delete_task': ns.get('delete_task'),
        'recover_task': ns.get('recover_task'),
        'remove_task_forever': ns.get('remove_task_forever'),
        'manage_tasks': ns.get('manage_tasks'),
        'global_ns': ns,
    }
