...
class GlobalMarketSentinel(AttentionStrategyBase):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            scope='global',
            min_global_attention=0.0,  # 始终运行，监控市场
    ...
    def analyze(self, data: pd.DataFrame, context: Dict[str, Any]) -> List[Signal]:
        ...
        self.attention_history.append(context.get('global_attention', 0.5))
        ...
        if self.execution_count % 10 == 0:
            self._print_status_report(
                volatility, mean_change, up_ratio, down_ratio,
                extreme_down, context.get('global_attention', 0.5)
            )
    ...
    def _print_status_report(
        ...
        print(f"全局注意力: {global_attention:.2f}")
