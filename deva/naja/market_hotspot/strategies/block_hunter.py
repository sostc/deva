...
class BlockRotationHunter(HotspotStrategyBase):
    """
    Block Rotation Hunter Strategy
    ...
    def __init__(
        ...
        self.min_block_hotspot = min_block_hotspot
    ...
    def _detect_rotation(self, block_weights: Dict[str, float]) -> List[Signal]:
        ...
        for block_id, weight in block_weights.items():
            ...
            if weight < self.min_block_hotspot:
                continue
    ...
    def _identify_hot_blocks(self, block_weights: Dict[str, float]) -> List[str]:
        ...
        for block_id, weight in block_weights.items():
            ...
            if weight > self.min_block_hotspot and momentum > 0:
                hot_blocks.append({
                    'block': block_id,
                    'weight': weight,
                    'momentum': momentum,
