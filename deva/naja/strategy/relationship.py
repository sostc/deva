...
STRATEGY_RELATIONSHIPS = {
    "选股场景": {
        ...
        "typical_flow": "先用市场状态分类判断环境，再用资金流向/题材动量过滤，最后用选股策略精选"
    },
    "方向预测": {
        "color": "#3b82f6",
        "bg_color": "#dbeafe",
    ...
    "市场分析": {
        ...
        "description": "分析整体市场状态和题材轮动",
        "typical_flow": "市场状态分类 → 题材动量 → 资金流向 → 选股"
    },
    "异常检测": {
        "color": "#ef4444",
        "bg_color": "#fee2e2",
...
STRATEGY_RECOMMENDED_FLOWS = [
    {
        "name": "稳健选股",
        "steps": ["市场状态分类", "题材动量分析", "题材牛股精选"],
        "description": "先判断市场环境，再分析题材轮动，最后精选个股"
    },
    {
        "name": "激进选股",
    ...
    {
        "name": "舆情驱动",
        "steps": ["新闻舆情记忆", "市场状态分类", "题材动量分析"],
        "description": "基于舆情分析市场状态，指导题材配置"
    },
]
